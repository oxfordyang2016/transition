...
cursor1.execute("create table IF NOT EXISTS ivp.infoofivp(id INT NOT NULL AUTO_INCREMENT,ivpid varchar(60),ip varchar(60),user varchar(60),phone varchar(60),addressofdevice varchar(60),devicestatus varchar(60),PRIMARY KEY(id));")
db1.commit()
db1.close()
